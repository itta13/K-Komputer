...
<div class="row">
    <div class="col-md-6">
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <button class="btn btn-primary" name="import"><span class="fa fa-import"></span> Import</button>
                <a class="btn btn-danger" href="?m=dataset"><span class="fa fa-arrow-left"></span> Kembali</a>
            </div>
        </form>
    </div>
</div>